...
export default function AttendanceGuests() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 text-vrayi mb-10  ">


      <form onSubmit={handleSubmit} className="text-xl space-y-10">
        <motion.h1 {...anim} className="my-20 text-[28px] font-bold">
          Հրավերի պատասխան
        </motion.h1>
        {/* Full Name */}
        <div>
        ...
        <div>
          ...
          <motion.div {...anim} className="flex gap-3">
            <button
              ...
              className={`flex-1 p-3 rounded-lg border transition-all duration-200 ${formData.familySide === "Հարսի կողմից"
                  ? "bg-guyn text-guyn2 border-guyn"
                  : " "
                }`}
            >
              Հարսի
            ...
            <button
              ...
              className={`flex-1 p-3 rounded-lg border transition-all duration-200 ${formData.familySide === "Փեսայի կողմից"
                  ? "bg-guyn text-guyn2 border-guyn"
                  : ""
                }`}
            >
        ...
        <div>
          ...
          <motion.div {...anim} className="flex gap-3">
            <button
              ...
              className={`flex-1 p-3 rounded-lg border transition-all duration-200 ${formData.attending === "Այո"
                  ? "bg-guyn text-guyn2 border-guyn"
                  : " "
                }`}
            >
            ...
            <button
              ...
              className={`flex-1 p-3 rounded-lg border transition-all duration-200 ${formData.attending === "Ոչ"
                  ? "bg-guyn text-guyn2 border-guyn"
                  : ""
                }`}
            >
        ...
        <motion.button
          ...
          className="w-full p-3 bg-guyn text-guyn2 rounded-lg"
        >
      ...
      {message.text && (
        <motion.div
          {...anim}
          className={`p-4 mb-4 mt-10 rounded-lg ${message.type === "success"
